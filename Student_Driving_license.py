...
def place():
    drivers_id = 4981380274
    print(type(drivers_id))
    name = "Swastik Mankotia"
    print(type(name))
    dob = "10/12/2009"
    print(type(dob))
    pin = 397106
    print(type(pin))
    address = "5118 Berkeley Creek Ln."
    print(type(address))
    vehicle_type = "Four, Six"
    print(type(vehicle_type))
    label_id['text'] = drivers_id
...
button1 = Button(root, text="Show Drivers License", command=place)
